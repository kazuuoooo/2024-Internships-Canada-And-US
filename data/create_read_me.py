...
for listing in listings:
    ...
    link_button = (f'<a href="{apply_url_encoded}"><img src="data/images/applybutton.png" alt="Apply Button" style="width:80px;"></a>'
                    f'<a href="https://www.interninsider.me/subscribe"><img src="data/images/interninsidersmall.png" alt="Intern Insider" style="width:40px;"></a>'
